...
เราก็จะมีการใช้ชื่อเรียกว่า `น้องโปรแกรม` ให้เหมือนโปรแกรมมีตัวตนขึ้นมาจริงๆ เพราะความเชื่อที่ว่าหมาแมวทุกวันนี้อยู่รอดได้เพราะ `ความน่ารัก` เลยมีคนเลี้ยงดูอย่างดีราวกับเราเป็นทาสไปซะเอง ก็เลยอยากจะทำให้น้องโปรแกรมดูเหมือนมีตัวตนที่แฝงความน่ารักน่าชังจากความดื้อของเขา ไม่ว่าจะบัค จะเขียนโปรแกรมยากขนาดไหน ต้องป้อนอินพุทไปเท่าไหร่ถึงจะอิ่ม เราก็จะพยายามเพื่อเขา จนเรากลายเป็น `ทาสโปรแกรม` ไปแบบไม่รู้ตัว
