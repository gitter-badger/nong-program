# Become the one of Nong Program
...
เราก็จะมีการใช้ชื่อเรียกว่า `น้องโปรแกรม` ให้เหมือนโปรแกรมมีตัวตนขึ้นมาจริงๆ เพราะความเชื่อที่ว่าหมาแมวทุกวันนี้อยู่รอดได้เพราะ `ความน่ารัก` เลยมีคนเลี้ยงดูอย่างดีราวกับเราเป็นทาสไปซะเอง ก็เลยอยากจะทำให้น้องโปรแกรมดูเหมือนมีตัวตนที่แฝงความน่ารักน่าชังจากความดื้อของเขา ไม่ว่าจะบัค จะเขียนโปรแกรมยากขนาดไหน เราก็จะพยายามเพื่อเลี้ยงดูเขาจนเราสามารถอยู่ร่วมกันได้นั้นเอง

เพราะผม [(@nakorndev)](https://github.com/nakorndev) ได้เห็นสภาพหลังจบการศึกษามาว่า การเรียนรู้ในระบบการศึกษามันไม่เพียงพอต่อการนำไปทำงานจริงๆสักเท่าไหร่ และยังมีบทความที่น่าสนใจมากมายดันถูกกระจัดกระจาย ไม่สามารถตามอ่านเนื้อหาที่น่าสนใจของแต่ล่ะคนได้ เราจึงนำมามัดรวมเป็นน้องโปรแกรมชุดเดียว ที่ให้ทุกคนสามารถเข้าถึงได้อย่างรวดเร็ว
...
ทุกๆไฟล์ `.md` ที่แก้ไขจะต้องมีโค้ดดังต่อไปนี้อยู่บนส่วนหัวสุด ตามตัวอย่างไฟล์อื่นๆ เพื่อให้ Jekyll ทำการ Build เอกสารออกมาอย่างถูกต้อง
...
เนื้อหาทั้งหมดจะถูกคุ้มครองลิขสิทธิ์ในรูปแบบ [MIT license](https://www.gnu.org/licenses/lgpl-3.0.en.html) โดยทางเราอนุญาตให้คัดลอก ทำซ้ำ ดัดแปลงเนื้อหาได้อย่างอิสระ
