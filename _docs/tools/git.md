...
- ช่วยเก็บการโค้ดของคุณไว้ในที่ๆหนึ่งได้ เช่น บนอินเตอร์เน็ต ทำให้คุณสามารถเข้าถึงได้อย่างสะดวก และมีโค้ดตัวอย่างเก็บไว้ใช้ภายหลังได้
...
> - **Bug** เป็นศัพท์เฉพาะของโปรแกรม ซึ่งหมายถึงว่าโปรแกรมมีปัญหาหรือจุดบกพร่อง หากเป็นศัพท์ทั่วไปแปลว่าแมลง เป็นคำที่มีที่มาจากคอมพิวเตอร์สมัยเก่ามักมีปัญหาเมื่อแมลงไปติดในอุปกรณ์ต่างๆ เพราะคอมเมื่อก่อนมีขนาดใหญ่และมีช่องแคบเหมาะแก่ที่อยู่ของแมลง จึงมีคำว่า "เอาบัคออกไปที ทำโปรแกรมมีปัญหาอีกแล้ว" และถูกเรียกกันจนติดปากเมื่อโปรแกรมมีปัญหา ซึ่งสมัยนี้บัคก็กลายเป็นปัญหาที่เกิดจากโปรแกรมเมอร์โดยส่วนใหญ่แมลงไม่ได้ผิดแต่อย่างใด... 🐞🐞🐞
...
หลังจากติดตั้งเสร็จ สามารถทำการตรวจสอบได้โดยเปิด **Terminal** หรือ **Console** และสั่งคำสั่งดังต่อไปนี้เพื่อดูว่าสามารถทำงานบนเครื่องของคุณปกติหรือไม่ โดยจะมีการแสดง Version ของโปรแกรม Git แสดงผลขึ้นมา
...
> - **Terminal** คือหน้าจอรับคำสั่งในระบบ จะเป็นเครื่องมือหลักของโปรแกรมเมอร์เพื่อใช้สั่งงานต่างๆ
>   - Mac สามารถเปิดได้โดยกดปุ่ม `cmd` + `space` พร้อมกัน
>   - Linux สามารถเปิดได้โดยกดปุ่ม `ctrl` + `alt` + `c` พร้อมกัน
> - **Console** เช่นเดียวกับ Terminal สามารถเรียกได้ทั้งสองคำนี้ แต่บน Windows จะถูกใช้คำนี้มากกว่า และเป็นชื่อผลิตภัณฑ์ของทาง Windows
>   - Windows สามารถเปิดได้โดยกดปุ่ม `win` + `r` พร้อมกันเพื่อเปิดหน้าต่าง Run จากนั้นพิมพ์คำว่า `cmd` และกด `enter`
>
> ![Run Windows]({{ 'assets/images/content-git-run-windows.jpg' | absolute_url }})
